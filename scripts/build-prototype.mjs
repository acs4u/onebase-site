...
const customers = [
  ...
  { seg: 'Fitness clubs', names: ['The Edge Fitness Clubs', 'VIDA Fitness', 'PURE Family Fitness', 'Harbor Square Athletic Club', 'Razor Sharp Fitness', 'Balance Gym', 'REGYMEN Fitness', 'Soluna Fitness', 'The Rising Zone', 'Wellness Solutions Inc.'] },
