...
const customers = [
  ...
  { seg: 'Real estate, hospitality & corporate', names: ['Centurion American', 'Joe Kain Homes', 'ReNUE Properties', 'Crescent Estates', 'Standard Architects', 'Loftco', 'Bang Salon', 'UPSTACK', 'Estampro', 'OneWater Marine', 'Palmetto', 'Lanvera', 'Advanced Green Technologies', 'Guardian Manufacturing', 'Transco MFG Australia', 'Australia Wide First Aid', 'Galway Holdings', 'Bright Spenders'] },
...
<section class="sec" style="background:var(--surf)"><div class="wrap stack" style="gap:28px">\${eyebrow('Customers')}<h2 style="max-width:720px">\${D.customers.reduce((a,c)=>a+c.names.length,0)}+ businesses across North America, Australia, Asia and Europe.</h2><div class="wall">\${D.customers.map(c=>\`<div><p class="eyebrow" style="margin-bottom:10px">\${c.seg}</p><div class="names">\${c.names.map(n=>\`<span>\${esc(n)}</span>\`).join('')}</div></div>\`).join('')}</div></div></section>
