...
const customers = [
  ...
  { seg: 'Brands, athletes & hospitality', names: ['Golden Hippo', 'Jake Paul', 'Kayla Barnes', 'Time to Bloom', 'Bang Salon', 'The Fox Tan'] },
];
...
<section class="sec"><div class="wrap">\${eyebrow('Partner logos')}<div class="logos" style="margin-top:16px">\${['usolympic','ussoccer','pga','nerevolution','lafc','healthfit','10x','covery','hype','hume','infinity','revital'].map(l=>D.img['logo-'+l]?\`<img src="\${D.img['logo-'+l]}" alt="\${l}" class="\${['usolympic','ussoccer','pga','nerevolution'].includes(l)?'crest':''}">\`:'').join('')}</div></div></section>
